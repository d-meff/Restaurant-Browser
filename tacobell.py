# IF YOUR TOWN DOES NOT HAVE A TACO BELL
...
def get_tacobell():
    ...
    tacobell_in_town = f'https://locations.tacobell.com/{your_state_abbr.lower()}/{condensed_town.lower()}.html'

    chrome_path = "C:/Program Files/Google/Chrome/Application/chrome.exe %s" 

    # If you have Google Chrome, replace 'chrome_path' with your file path. (Make sure to include the %s at the end.)

    webbrowser.get(chrome_path).open_new_tab(tacobell_in_town)